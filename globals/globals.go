...
var (
	...
	// DefaultAuthTokenTtl sets the maximum token time to live globally for
	// all tokens generated by all auth methods
	DefaultAuthTokenTtl = 7 * 24 * time.Hour

	// DefaultAuthTokenStalenessDuration sets the maximum time a token can live without
	// being used globally for all auth methods
	DefaultAuthTokenStalenessDuration = 24 * time.Hour
)
